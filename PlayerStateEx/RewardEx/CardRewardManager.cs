...
public class CardRewardManager
{
    ...
    public void AddGroup(ulong playerNetId, CardRewardGroup group)
    {
        ...
        MainFile.Logger.Debug($"[CardRewardManager] AddGroup: player={playerNetId}, groupId={group.GroupId}, cards={group.Cards.Count}");
    ...
    public void ClearGroups(ulong playerNetId)
    {
        ...
        MainFile.Logger.Debug($"[CardRewardManager] ClearGroups: player={playerNetId}");
        RewardsUpdated?.Invoke(playerNetId);
    }
    ...
    public static void Reset()
    {
        ...
        MainFile.Logger.Debug("[CardRewardManager] Reset: cleared all rewards");
    }
}
